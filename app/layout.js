...
const DOMAIN_METADATA_CONFIG = {
  "sakungems.procatalog.in": {
    defaultMeta: {
      title:
        "Sakungems | Gemstone Jewellery Manufacturer & Wholesale Jewellery Catalogue",
      description:
        "Explore premium gemstone jewellery collections from Sakungems manufacturer of elegant and modern gemstone jewellery designs.",
      keywords:
        "Sakungems, Gemstone Jewellery Manufacturer, Wholesale Jewellery Catalogue, Gemstone Jewellery Designs",
      author: "Sakungems",
    },
  ...
  "francisdiamonds.procatalog.in": {
    defaultMeta: {
      title:
        "Francis Diamonds | Diamond Jewellery Manufacturer & Wholesale Jewellery Catalogue",
      description:
        "Explore premium diamond jewellery collections from Francis Diamonds, a trusted manufacturer of elegant and modern diamond jewellery designs.",
      keywords:
        "Francis Diamonds, Diamond Jewellery Manufacturer, Wholesale Jewellery Catalogue, Diamond Jewellery Designs",
...
export default async function RootLayout({ children }) {
  ...
  const [{ default: LayoutComponent }, { default: StyleInjector }] =
    await Promise.all([
